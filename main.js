...
Badge.badgeImages = [{ // hello
  width: 128, height: 64, bpp: 1,
  transparent: 0,
  buffer: E.toArrayBuffer(atob(""))
}, { // nodeconf
  width: 128, height: 64, bpp: 1,
  transparent: 0,
...
Badge.sketch = () => {
  ...
  function onButton() {
    if (BTNA.read() && BTNB.read())
      return Badge.menu();
    if (digitalRead([BTNU, BTND, BTNL, BTNR, BTNA, BTNB])) {
      onFrame();
